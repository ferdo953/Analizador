...
public class Proyecto extends javax.swing.JFrame {
    String ruta = "C:/Users/Public/Analizador.txt";
    ...
    private void initComponents() {
        ...
        tablavts.setBackground(new java.awt.Color(204, 204, 255));
        tablavts.setForeground(new java.awt.Color(0, 51, 51));
        ...
        tablavts2.setBackground(new java.awt.Color(204, 204, 255));
        tablavts2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Token de Error", "Lexema", "Linea de Error", "Descripcion"
            }
        ));
        ...
        jLabel3.setText("Tabla de Tokens de error");

        tablavtss.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jLabel4.setText("Variables Declaradas");
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(btn1, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(56, 56, 56))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(54, 54, 54)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
       ...
       ArrayList<String> cadenas = new ArrayList<String>(); //as
        ...
        int aid=1,aoa=1,aas=1,asep=1,acne=1,acnpf=1,adel=1,atd=1,errsem=1,b=0,suma=0,suma2=0;
           ...
           StringTokenizer tokens=new StringTokenizer(expresion," \n\t",true);  
                ...
                if(verdad==a.matches(TD)){ 
                    ...
                    ErrorSemantico f = new ErrorSemantico(guardar3,a);
                    f.vardeclaradas();
                    datos3[1]=f.datos3[1];
                    b=f.b;
                    
                    ErrorSemantico d = new ErrorSemantico(guardar2,guardar4,guardar5,p,a,h,b);
                    d.Nodeclarados();
                    k=d.k;
                    ...
                    if(b==5 && k==0 && guardar3.size()>2){
                            ...
                            datos2[3]="Variable aun no definida";
                            model2.addRow(datos2);
                            tablavts2.setModel(model2); 
                            guardar4.add(a+p);
                            h++;errsem++;
                    }else if(b==0){
                        ErrorSemantico m = new ErrorSemantico(guardar2,guardar5,a,l,b);
                        m.Declarados();
                        u=m.u;  
                        ...
                        ErrorSemantico N = new ErrorSemantico(guardar2,guardar4,guardar7,p,a,v,b);
                        N.declarados2();
                        k=N.k;
                  ...
                  ErrorSemantico o = new ErrorSemantico(guardar3,guardar6,j);
                  o.Aritmetico();
                  oa=o.as;
                  guardar6=o.guardar7;
                     ...
                     String j=guardar3.get(guardar3.size()-2);  
                     ErrorSemantico o = new ErrorSemantico(guardar3,guardar7,j);
                     o.Igualacion();
                     as=o.as;
                     guardar7=o.guardar7;
        ...
        TriplosCuadr f = new TriplosCuadr(txt1.getText());;
        triplo1=cadenas;
        String OA = "(\\+|\\-|\\*|\\/|\\=)";
       
        String txt="";
        TriplosCuadr f3 = new TriplosCuadr();
        try{
            f3.Haciendo();
        }catch(Exception e){
            System.out.println(e);
        ...
        for (int i = 0; i < triplo1.size(); i++) {
            ...
            if(triplo1.get(i).equals("=")){
               ...
               if(entro==0){
                    f3 = new TriplosCuadr(triplo1.get(i-1),txt,contando);
                    f3.triplo2();
                    contando=f3.contando;
                    txt="";
               }else{      
                   System.out.println(vacio);
                    f3 = new TriplosCuadr(triplo1.get(i-1),txt,contando,contador,paren,relacional,vacio,tr);
                    f3.triplo2();
                    contando=f3.contando;
                    txt="";
                    if(paren==0){
               ...
               relacional=0;
                ...
                f3 = new TriplosCuadr(null,txt,contando,contador,paren,relacional,vacio,tr,entro);
                f3.triplo2();
                contando=f3.contando;
                txt="";     
            ...
            if(triplo1.get(i).equals("=")){
               ...
               if(entro==0){
                   ...
                   System.out.println(auxiliando);
                    f3 = new TriplosCuadr(triplo1.get(i-1),txt,contando,contador,paren,relacional,vacio,auxiliando,cierres);
                    f3.triplo();
                    contando=f3.contando;
                    txt="";
               ...
               relacional=0;
                ...
                contador+=2;
                txt=triplo1.get(i-1)+" "+triplo1.get(i)+" "+triplo1.get(i+1);
                f3 = new TriplosCuadr(null,txt,contando,contador,paren,relacional,vacio,tr,entro,cierres,trs);
                f3.triplo();
                contando=f3.contando;
                txt="";   
                trs++;
