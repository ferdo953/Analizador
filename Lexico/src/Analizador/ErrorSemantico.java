...
public class ErrorSemantico {
    ...
    String[] datos2 = new String[4];
     ...
     public ErrorSemantico(ArrayList<String> guardar2,ArrayList<String> guardar4,ArrayList<String> guardar5,int p,String a,int h,int b){
    ...
    public ErrorSemantico(ArrayList<String> guardar3, String a){
        this.guardar3=guardar3;
        this.a=a;
        
    }   
    
    public ErrorSemantico(ArrayList<String> guardar2,ArrayList<String> guardar5, String a,int l,int b){
        this.guardar2=guardar2;
        this.guardar5=guardar5;
        this.a=a;
        this.l=l;
    ...
    public ErrorSemantico(ArrayList<String> guardar3,ArrayList<String> guardar7, String j){
        this.guardar3=guardar3;
    ...
    public ErrorSemantico vardeclaradas(){
        ...
        return new ErrorSemantico(guardar3,a);
    }
    
    public ErrorSemantico Nodeclarados(){
       ...
       if(b==5){
        ...
        return new ErrorSemantico(guardar2,guardar4,guardar5,p,a,h,b);
    }
    
    public ErrorSemantico declarados2(){ 
  ...
  //si entra quiere decir que hubo algun otro id error que se repitio
    ...
    public ErrorSemantico Declarados(){
        ...
        return new ErrorSemantico(guardar2,guardar5,a,l,b);
    }
    
    public ErrorSemantico Igualacion(){
        guardar7.clear();
        as=5;
        for (int i = 0; i < guardar3.size() ; i++) {
        ...
        return new ErrorSemantico(guardar3,guardar7,j);
    }
    
    public ErrorSemantico Aritmetico(){
        guardar7.clear();
        as=5;
        for (int i = 0; i < guardar3.size() ; i++) {
