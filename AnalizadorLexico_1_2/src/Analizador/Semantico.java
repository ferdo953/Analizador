...
public class Semantico {
    ...
    String[] datos2 = new String[4];
     ...
     public Semantico(ArrayList<String> guardar2,ArrayList<String> guardar4,ArrayList<String> guardar5,int p,String a,int h,int b){
    ...
    public Semantico(ArrayList<String> guardar3, String a){
        this.guardar3=guardar3;
        this.a=a;
        
    }   
    
    public Semantico(ArrayList<String> guardar2,ArrayList<String> guardar5, String a,int l,int b){
        this.guardar2=guardar2;
        this.guardar5=guardar5;
        this.a=a;
        this.l=l;
    ...
    public Semantico(ArrayList<String> guardar3,ArrayList<String> guardar7, String j){
        this.guardar3=guardar3;
    ...
    public Semantico vardeclaradas(){
        ...
        return new Semantico(guardar3,a);
    }
    
    public Semantico Nodeclarados(){
       ...
       if(b==5){
        ...
        return new Semantico(guardar2,guardar4,guardar5,p,a,h,b);
    }
    
    public Semantico declarados2(){ 
  ...
  //si entra quiere decir que hubo algun otro id error que se repitio
    ...
    public Semantico Declarados(){
        ...
        return new Semantico(guardar2,guardar5,a,l,b);
    }
    
    public Semantico Igualacion(){
        guardar7.clear();
        as=5;
        for (int i = 0; i < guardar3.size() ; i++) {
        ...
        return new Semantico(guardar3,guardar7,j);
    }
    
    public Semantico Aritmetico(){
        guardar7.clear();
        as=5;
        for (int i = 0; i < guardar3.size() ; i++) {
