...
public class Tripleando {
        ...
        int bandera=0,jerarsuma=0,h=1,bandera2=0,noentro=0,contador=0,entro=0,p=0,k=0,iff=2,conrel=0,contando,contwh=0,sientra=0,paren=1,relacional=1,contando2=1,vacio=1,tr=1,numtr=1,trs=1;
        ...
        public Tripleando(String expresion){
            this.expresion=expresion;
         
        }
        public Tripleando(String expresion,int contando,int contando3){
            this.expresion=expresion;
            this.contando2=contando;
            this.contwh=contando3;
        }
        
        public Tripleando(String letra,String expresion,int contando){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
        }
        
        public Tripleando(String letra,String expresion,int contando,int contando2){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.contando2=contando2;
        }
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,int entro){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,int entro,ArrayList<String> array,int trs){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,int entro,ArrayList<String> array,int trs,int contando2,int contwh,int conrel){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,ArrayList<String> array){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,ArrayList<String> array,int contando2){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,ArrayList<String> array,int contando2,int contwh){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,ArrayList<String> array,int contando2,int contwh,int iff){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
         ...
         public Tripleando(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Tripleando convirtiendo(){
            ...
            return new Tripleando(otro,contando,contando2);
        }
        
       
        public Tripleando convirtiendopre(){
            StringTokenizer tokens=new StringTokenizer(expresion);
            while(true){      
                if(tokens.hasMoreTokens()){
                    guardar.add(tokens.nextToken());  
        ...
        if(archivo2.exists()) {
            ...
            for(int i=0;i<guardar.size();i++){               
                   if(i>0){                            
                     ...
                     if(entro==1 | entro==3){
                                bwr.write(contando2+"   JMP else"+(contwh)+"\n");
                                contando2++;
            ...
            if(this.paren==0 && relacional==0 && tr==1){
                
                    bw.write(contando+"         "+"JMP"+"                    "+ "" +"                    "+(Integer.parseInt(this.array.get(0))-1)+"\n");
                    array.remove(0);
                    contando++;
            } 
            ...
            if(iff==1){ 
                    ...
                    contando2++;
                    bwr.write(contando2+"   else"+contwh+":\n");
                    contando2++;              
            }else if((vacio==2 | vacio==0) && iff==0){
                    bwr.write(contando2+"   else"+contwh+":\n");
                    contando2++;
            }
