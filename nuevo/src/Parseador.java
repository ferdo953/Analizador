...
public class Parseador {
        ...
        int bandera=0,jerarsuma=0,h=1,bandera2=0,noentro=0,contador=0,entro=0,p=0,k=0,contando,sientra=0,paren=1,relacional=1,vacio=1,tr=1,numtr=1;
        ...
        public Parseador(String expresion,int contando){
            this.expresion=expresion;
        ...
        public Parseador(String letra,String expresion,int contando,int sientro,int paren,int relacional,int vacio,int tr,int entro,ArrayList<String> array){
            this.expresion=expresion;
            this.letra=letra;
            this.contando=contando;
            this.sientra=sientro;
        ...
        public Parseador convirtiendo(){
            ...
            return new Parseador(otro,contando);
        }
            ...
            for(int i=0;i<guardar.size();i++){               
                   if(i>0){                            
                       ...
                       if(entro==1){ //Relacional solo                       
                           bw.write(contando+"         "+(contando+2+(4*(tr-1)))+"                    "+"TR1"+"                    "+"TRUE"+"\n");
                           contando++;
                           bw.write(contando+"         "+(contando+2+sientra)+"                    "+"TR1"+"                    "+"FALSE"+"\n");
                           contando++;                          
                       }else if(entro==2){ //relacional or, segunda instruccion
                           bw.write(contando+"         "+(contando+2+(4*(tr-1)))+"                    "+"TR1"+"                    "+"TRUE"+"\n");
                           contando++;
                           bw.write(contando+"         "+(contando+1)+"                    "+"TR2"+"                    "+"FALSE"+"\n");
                           contando++;
                       }else if(entro==3){
                            bw.write(contando+"         "+(contando+2)+"                    "+"TR1"+"                    "+"TRUE"+"\n");
                            contando++;
                            bw.write(contando+"         "+(Integer.parseInt(this.array.get(0))-1)+"                    "+"TR2"+"                    "+"FALSE"+"\n");
                            contando++;
                            array.remove(0);
                       }
