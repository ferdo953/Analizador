        ...
        for (int i = 0; i < triplo1.size(); i++) {
            ...
            if(triplo1.get(i).equals("=")){
               ...
               if(entro==0){
                    ...
                    f3 = new Parseador(triplo1.get(i-1),txt,contando,contador,paren,relacional,vacio,auxiliando,cierres);
                    f3.triplo();
                    contando=f3.contando;
                    txt="";
               ...
               relacional=0;
                ...
                contador+=2;
                txt=triplo1.get(i-1)+" "+triplo1.get(i)+" "+triplo1.get(i+1);
                f3 = new Parseador(null,txt,contando,contador,paren,relacional,vacio,auxiliando,entro,cierres,trs);
                f3.triplo();
                contando=f3.contando;
                txt="";   
                trs++;
